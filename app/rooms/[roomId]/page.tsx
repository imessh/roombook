      ...
      {loading || !room ? (
        ...
        <div className="bg-card rounded-3xl shadow-card p-6 mb-6 flex flex-wrap items-center gap-5">
          ...
          <button
            ...
            className="focus-ring ml-auto flex items-center gap-2 bg-brand text-white rounded-2xl shadow-soft px-4 py-2.5 text-sm font-semibold hover:bg-brand-dark"
          >

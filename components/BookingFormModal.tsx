...
export function BookingFormModal({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      if (isEditing && editingBooking && editingBooking.createdBy !== user?.uid) {
        throw new Error("Only the booking owner can edit this booking.");
      }
          ...
          >
            ...
            <div className="flex gap-2 pt-1">
              ...
              <button
                type="submit"
                disabled={saving}
                className="focus-ring flex-1 rounded-xl btn-gradient text-white font-medium text-sm py-2.5 hover:scale-[1.02] transition-transform disabled:opacity-60 disabled:hover:scale-100"
              >

    ...
    <div className="min-h-screen bg-bg flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-card rounded-3xl shadow-card p-7">
          ...
          <p className="text-sm text-ink-400 mb-6">Set up access to book meeting rooms and halls.</p>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold text-ink-500 mb-1.5" htmlFor="name">
                Full name
              </label>
            ...
            <button
              type="submit"
              disabled={loading}
              className="focus-ring w-full rounded-xl btn-gradient text-white font-medium text-sm py-2.5 hover:scale-[1.02] transition-transform disabled:opacity-60 disabled:hover:scale-100"
            >

  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        aria-expanded={open}
        className="focus-ring flex items-center gap-2 glass rounded-2xl shadow-soft px-4 py-2.5 text-sm font-medium text-ink-700 hover:text-ink-900"
      >
        {label}
      ...
      {open && (
        <div
          role="listbox"
          className="absolute z-20 mt-2 w-full sm:w-56 glass rounded-2xl shadow-popover py-2 max-h-72 overflow-auto"
        >
          <DropdownOption
